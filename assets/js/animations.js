...
// const shift = function(runAnimations) {
//     const removeMecury = document.querySelector('.planets.mercury');

//     document.addEventListener("keydown", function(e) {
//         if(e.which === 9) {
//             removeMecury.classList.remove('mercury');
//             console.log(removeMecury);
//         }
//     });
